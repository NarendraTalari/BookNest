      ...
      {item && (
        <div>
            ...
            <img 
              ...
              onError={(e) => {
                console.log(`Error loading image for ${item.title || item.itemtype}`);
                e.target.src = `https://via.placeholder.com/450x450?text=${encodeURIComponent(item.title || item.itemtype || 'Book Cover')}`;
              }}
            />
                </div>
